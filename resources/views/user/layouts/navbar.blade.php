<div class="fixed-top bg-white">
	<div class="container">
        <div class="d-flex py-3 align-items-center justify-content-between">
        	...
        	<div class="d-flex align-items-center">
                <a href="{{ env('APP_URL') }}" class="text-decoration-none d-block rounded-circle cursor-pointer bg-theme-color text-center" style="width: 25px; height: 25px; line-height: 20px;" target="_blank">
                    <small class="text-white tiny-font">
                        <i class="icofont-web"></i>
                    </small>
                </a>
                <div class="dropdown ml-2">
                    <a href="javascript:;" class="text-decoration-none d-block rounded-circle cursor-pointer bg-theme-color text-center" id="user-{{ auth()->id() }}" data-toggle="dropdown" data-offset="35, 15" style="width: 25px; height: 25px; line-height: 20px;">
                        <small class="text-white tiny-font">
