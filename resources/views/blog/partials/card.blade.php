<div class="card border-0">
    <div class="card-img position-relative">
        ...
        @if(empty($blog->image))
            ...
            <a href="{{ route('blog.edit', ['id' => $blog->id]) }}" style="height: 180px;" class="d-block">
    ...
    <div class="card-body">
        <div class="pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
            <a href="{{ route('blog.edit', ['id' => $blog->id]) }}" class="text-underline">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('blog.dashboard', ['category' => \Str::slug(strtolower($blog->category))]) }}" class="text-main-dark text-underline">
