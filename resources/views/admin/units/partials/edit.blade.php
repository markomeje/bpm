<div class="modal fade" id="edit-unit-{{ $unit->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content card-raduis border-0">
            <form method="post" action="javascript:;" class="edit-unit-form" data-action="{{ route('admin.unit.edit', ['id' => $unit->id]) }}" autocomplete="off">
                <div class="modal-body p-4">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control price rounded-0" name="price" placeholder="e.g., 10" value="{{ $unit->price }}">
                            <small class="invalid-feedback price-error"></small>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="text-main-dark">Units</label>
                            <input type="number" class="form-control units rounded-0" name="units" placeholder="e.g., 345" value="{{ $unit->units }}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control duration rounded-0" name="duration" placeholder="e.g., 10" value="{{ $unit->duration }}">
                    ...
                    <div class="alert mb-3 edit-unit-message d-none"></div>
                    <div class="d-flex justify-content-right mb-3 mt-1">
                        <button type="submit" class="btn btn-info btn-lg text-white edit-unit-button px-4">
                            <img src="/images/spinner.svg" class="mr-2 d-none edit-unit-spinner mb-1">
                            Save
                        </button>
                    </div>
                </div>
